...
export class EditEmployee extends Component<EditEmployee.Props, EditEmployee.State> {
  ...
  handleBirthdateChanged = (date: Date | null) => {
    ...
    this.processInputChange(
      { birthdate },
      () => this.props.actions.updateDateField(this.state.employeeId, { value: birthdate }, 'birthdate'),
    );
  }
  ...
  handleTagsChange = (newTags: Array<any>) => {
    this.processInputChange(
      { tags: newTags },
      () => this.props.actions.updateStringField(this.state.employeeId, { value: JSON.stringify(newTags) }, 'tags'),
    );
  }
  ...
  handleSalaryTypeChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    this.processInputChange(
      ...
      () => this.props.actions.updateStringField(this.state.employeeId, { value }, 'salaryType'),
    );
  }
